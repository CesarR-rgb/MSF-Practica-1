...
siganl = ['Escalon','Impulso','Rampa', 'Sin']
...
plt.show()
fig1.savefig('Escalonp1.pdf',bbox_inches = 'tight')
...
plt.legend(bbox_to_anchor = (0.5,-0.2), loc = 'center', ncol = 3, fontsize = 8, frameon = False ) 
plt.show()
fig2.savefig('Impulsop1.pdf',bbox_inches = 'tight')
...
plt.legend(bbox_to_anchor = (0.5,-0.2), loc = 'center', ncol = 3, fontsize = 8, frameon = False ) 
plt.show()
fig3.savefig('Rampap1.pdf',bbox_inches = 'tight')
...
plt.legend(bbox_to_anchor = (0.5,-0.2), loc = 'center', ncol = 3, fontsize = 8, frameon = False ) 
plt.show()
fig4.savefig('Sinup1.pdf',bbox_inches = 'tight')
